...
out = fast_partial_trace_quadrature(H,Qk,m,d_a,d_b,n_evec=k,max_iter=max_iter,termination_cond=termination_cond)
...
np.save(f'{directory}/{data_directory}/{experiment_name}',data,allow_pickle=True)